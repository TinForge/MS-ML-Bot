...
class DebugPanel(LabelFrame):
    def __init__(self, frame):
        ...
        self.iou_slider = Scale(self, from_=0, to=1, orient="horizontal", variable=values.model_iou, command=self.on_iou_changed)
        self.iou_slider.grid(row=1, column=1, padx=15, pady=5, sticky="W")

        self.conf_text = Label(self, text="Null")
        self.conf_text.grid(row=2, column=0, padx=15, pady=5, sticky="W")
        self.conf_slider = Scale(self, from_=0, to=1, orient="horizontal", variable=values.model_conf, command=self.on_conf_changed)
        self.conf_slider.grid(row=2, column=1, padx=15, pady=5, sticky="W")
        ...
        self.debug3.grid(row=5, column=1, padx=15, pady=5, sticky="W")

        self.debug4 = Label(self, text="Null")
        self.debug4.grid(row=6, column=1, padx=15, pady=5, sticky="W")

        self.debug5 = Label(self, text="Null")
        self.debug5.grid(row=7, column=0, padx=15, pady=5, sticky="W")
